...
/**
 * Created by zhengxin on 15/5/23.
 */
public class BdLog {
    static private final String LOG_TAG = "BaiduLog";
     ...
     * @return
     */
    static public void i(String className, String method, String msg) {
     ...
     * @return
     */
    static public void e(String className, String method, String msg) {
...
//            logToSDcard(log);
     ...
     * @return
     */
    static public void e(String className, String method, Throwable t) {
        String log = createMsg(false, className, method, t.getMessage());
        if (log != null) {
//            logToSDcard(log);
            Log.e(LOG_TAG, log);
        }
     ...
     * @return
     */
    static public void w(String className, String method, String msg) {
        String log = createMsg(false, className, method, msg);
        if (log != null) {
            Log.w(LOG_TAG, log);
        }
     ...
     * @return
     */
    static public void v(String className, String method, String msg) {
        String log = createMsg(true, className, method, msg);
        if (log != null) {
            Log.v(LOG_TAG, log);
        }
     ...
     * @return
     */
    static public void d(String className, String method, String msg) {
        String log = createMsg(true, className, method, msg);
        if (log != null) {
            Log.d(LOG_TAG, log);
        }
     ...
     * @return
     */
    static public void d(Class<?> cls, String method, String msg) {
        d(cls.getName(), method, msg);
    }
     ...
     * @return
     */
    static public void e(Class<?> cls, String method, Throwable t) {
        e(cls.getName(), method, t.getMessage());
    }
