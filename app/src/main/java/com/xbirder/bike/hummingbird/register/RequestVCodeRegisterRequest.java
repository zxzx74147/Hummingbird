 ...
 */
public class RequestVCodeRegisterRequest extends HttpJsonRequest<JSONObject> {

    private String mPhoneNum;
    public RequestVCodeRegisterRequest(HttpResponse.Listener<JSONObject> listener) {
        super(listener);
    }
    ...
    protected void onSetParameter(HashMap<String, String> params) {
        params.put("r", NetworkConfig.REQUSET_VCODE_REGISTER);
