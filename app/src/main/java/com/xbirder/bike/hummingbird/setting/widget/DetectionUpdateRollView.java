...
public class DetectionUpdateRollView extends ImageView {
    ...
    public DetectionUpdateRollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DetectionUpdateRollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas){
        ...
        if(getDrawable() instanceof BitmapDrawable){
            ...
            float strokeWidth = getWidth()*0.044f;
